...
/**
    ...
     * @param phoneNumberSet 手机号码列表
     * @return com.tencentcloudapi.sms.v20210111.models.SendSmsResponse
     *//*

    public SendSmsResponse sendMessage(String[] templateParamSet, String[] phoneNumberSet) throws BaseException {
        try {
            */
/* 必要步骤：
